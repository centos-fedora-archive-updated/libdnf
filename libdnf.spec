...
Patch1:         0001-add-nsvcap-parsing-support.patch
Patch2:         0002-add-tests-for-module-forms.patch
Patch3:         0003-use-long-long-for-module_form-version-instead-of-int.patch
